...
<head>
    ...
    <meta name="description"
        content="Atelier - Especial de Flores para el Día de la Madre. Los detalles más hermosos para celebrar a Mamá con amor infinito.">
    <title>Atelier | Día de la Madre</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <section class="hero-mom animate-fade-up" id="inicio">
        <div class="hero-mom-left">
            <img src="../assets/images/fondo_diaDeLaMadre.jpg" class="hero-mom-img" alt="Madre e hija Atelier Florería">
        </div>
        <div class="hero-mom-right">
            ...
            <div class="hero-mom-content">
                ...
                <h1 class="hero-mom-title">MAMÁ</h1>
            ...
            <div class="grid collection-grid">
                ...
                <div class="product-card fade-in">
                    <div class="product-img-wrapper">
                        ...
                        <img src="../assets/images/cesto_lilas.png" alt="Cesto Rosas" class="product-img">
                ...
                <div class="product-card fade-in delay-1">
                    ...
                    <div class="product-info">
                        ...
                        <p class="desc">Florero de vidrio con rosas importadas en tonos lilas y blancos</p>
                        <p class="price">S/ 149.90</p>
                        <button class="btnComprar btn btn-agregar">Agregar</button>
                    </div>
                </div>
                ...
                <div class="product-card fade-in delay-2">
                    ...
                    <div class="product-info">
                        ...
                        <p class="desc">Caja boutique con rosas rosadas y claveles seleccionados a mano</p>
                ...
                <div class="product-card fade-in delay-3">
                    ...
                    <div class="product-info">
                        ...
                        <p class="desc">Ramo envuelto en papel coreano con rosas blancas y lilas</p>
                        <p class="price">S/ 129.90</p>
                        <button class="btnComprar btn btn-agregar">Agregar</button>
                    </div>
                </div>
