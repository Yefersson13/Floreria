...
// 5. Probar Registro Exitoso con Nombre de Usuario Duplicado pero diferente Correo
echo "\n--- Probando AuthController: Registro Duplicado de Usuario con diferente Correo ---\n";
$response = $controller->register('Pedro', 'otro@test.com', '988888888', 'OtraContra');
assertTrue($response['success'], 'El registro debe ser exitoso aunque el nombre de usuario ya exista si el correo es diferente.');
